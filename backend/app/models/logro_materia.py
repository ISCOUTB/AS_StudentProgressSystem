...
class LogroMaterias(SQLModel, table=True):
    """Asociación entre un logro y una materia. Un logro puede aplicar a una materia específica o ser global."""
    ...
    id_materia: uuid.UUID | None = Field(foreign_key="materias.id_materia", default=None)  # None = logro global

    # Estudiantes que tienen registrado este logro-materia
